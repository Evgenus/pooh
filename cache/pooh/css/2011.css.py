...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u');  }\n.btn_main       {   width: 129px;   background-image: url(')
        # SOURCE LINE 47
        __M_writer(unicode(PATH('/images/2011/green.png')))
        __M_writer(u');       }\n.btn_prog       {   width: 179px;   background-image: url(')
        # SOURCE LINE 48
        __M_writer(unicode(PATH('/images/2011/green.png')))
        __M_writer(u');       }\n.btn_video      {   width: 135px;   background-image: url(')
        # SOURCE LINE 49
        __M_writer(unicode(PATH('/images/2011/green.png')))
        __M_writer(u');       }\n.btn_photo      {   width: 123px;   background-image: url(')
        # SOURCE LINE 50
        __M_writer(unicode(PATH('/images/2011/green.png')))
        __M_writer(u');       }\n.btn_where      {   width: 201px;   background-image: url(')
        # SOURCE LINE 51
        __M_writer(unicode(PATH('/images/2011/green.png')))
        __M_writer(u');       }\n.btn_cont       {   width: 152px;   background-image: url(')
        # SOURCE LINE 52
        __M_writer(unicode(PATH('/images/2011/green.png')))
